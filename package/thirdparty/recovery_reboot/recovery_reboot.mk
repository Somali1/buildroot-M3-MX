...
RECOVERY_REBOOT_SOURCE=recovery_reboot-$(RECOVERY_REBOOT_VERSION).tar
RECOVERY_REBOOT_SITE=$(TOPDIR)/package/thirdparty/recovery_reboot
RECOVERY_REBOOT_SITE_METHOD=file
